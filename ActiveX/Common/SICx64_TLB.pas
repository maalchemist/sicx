...
// $Rev: 98336 $
// File generated on 24.06.2023 8:00:14 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\!ROOT\PING\FASM\PROJECTS\SICx\RELEASE\ActiveX\Common\SICx64 (1)
// LIBID: {2E137C0E-B342-4483-983C-9DB7F39E2F58}
// LCID: 0
// Helpfile:
// HelpString: SICx64 Library
// DepndLst:
...
const
  ...
  SICx64MajorVersion = 6;
  SICx64MinorVersion = 2;

  LIBID_SICx64: TGUID = '{2E137C0E-B342-4483-983C-9DB7F39E2F58}';

  IID_ISICx64: TGUID = '{40A2D3AA-C583-477D-930C-071617EC6F31}';
  CLASS_SICox64: TGUID = '{9654E9C0-FEA8-4159-B502-F0BB018106D2}';
type
...
// Interface: ISICx64
// Flags:     (0)
// GUID:      {40A2D3AA-C583-477D-930C-071617EC6F31}
// *********************************************************************//
  ISICx64 = interface(IUnknown)
    ['{40A2D3AA-C583-477D-930C-071617EC6F31}']
...
// *********************************************************************//
// The Class CoSICox64 provides a Create and CreateRemote method to
// create instances of the default interface ISICx64 exposed by
// the CoClass SICox64. The functions are intended to be used by
// clients wishing to automate the CoClass objects exposed by the
// server of this typelibrary.
// *********************************************************************//
  CoSICox64 = class
    class function Create: ISICx64;
    class function CreateRemote(const MachineName: string): ISICx64;
  end;
...
class function CoSICox64.Create: ISICx64;
begin
  Result := CreateComObject(CLASS_SICox64) as ISICx64;
end;

class function CoSICox64.CreateRemote(const MachineName: string): ISICx64;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_SICox64) as ISICx64;
end;
