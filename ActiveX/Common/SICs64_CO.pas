...
uses
  Winapi.Windows, Winapi.ActiveX, System.Classes, System.Win.ComObj, SICs64_TLB;
...
type
  T_SICs64 = class (TTypedComObject, ISICs64)
  protected
...
function T_SICs64.Version: LongWord;
begin
  Result := sic_version;
end;

function T_SICs64.CPUSupport: WordBool;
begin
  Result := sic_cpu_support;
end;

procedure T_SICs64.Setup (AConfig: Pointer);
begin
  sic_setup (AConfig);
end;

procedure T_SICs64.CreateTables;
begin
  sic_cretab;
end;

procedure T_SICs64.FreeTables;
begin
  sic_fretab;
end;

function T_SICs64.FunTableCreate: LongWord;
begin
  Result := sic_funtac;
end;

procedure T_SICs64.FunTableFree;
begin
  sic_funtaf;
end;

function T_SICs64.FunLoad: LongWord;
begin
  Result := sic_funloa;
end;

procedure T_SICs64.FunUnload;
begin
  sic_funulo;
end;

function T_SICs64.ConTableCreate: LongWord;
begin
  Result := sic_contac;
end;

procedure T_SICs64.ConTableFree;
begin
  sic_contaf;
end;

function T_SICs64.ConLoad: LongWord;
begin
  Result := sic_conloa;
end;

procedure T_SICs64.ConUnload;
begin
  sic_conulo;
end;

function T_SICs64.VarTableCreate: LongWord;
begin
  Result := sic_vartac;
end;

procedure T_SICs64.VarTableFree;
begin
  sic_vartaf;
end;

function T_SICs64.VarLoad: LongWord;
begin
  Result := sic_varloa;
end;

procedure T_SICs64.VarUnload;
begin
  sic_varulo;
end;

function T_SICs64.RunTableCreate: LongWord;
begin
  Result := sic_runtac;
end;

procedure T_SICs64.RunTableFree;
begin
  sic_runtaf;
end;

procedure T_SICs64.Init (ASic: Pointer);
begin
  sic_init (ASic);
end;

procedure T_SICs64.Done (ASic: Pointer);
begin
  sic_done (ASic);
end;

function T_SICs64.AddFuns (ASic: Pointer): Integer;
begin
  Result := 0;
  {$I T_SICx.AddFuns.pas}
end;

function T_SICs64.AddFun (ASic: Pointer; AFuname: PAnsiChar; AOffset: Pointer;
  AACount: Smallint; AFlags: Word): Integer;
begin
  Result := sic_afun (ASic, AFuname, AOffset, AACount, AFlags);
end;

function T_SICs64.RenameFun (ASic: Pointer; AFuname, AOrgname: PAnsiChar;
  AInvalidate: WordBool): Integer;
begin
  Result := sic_refun (ASic, AFuname, AOrgname, AInvalidate);
end;

function T_SICs64.DuplicateFun (ASic: Pointer; AFuname, AOrgname: PAnsiChar): Integer;
begin
  Result := sic_dufun (ASic, AFuname, AOrgname);
end;

function T_SICs64.ExchangeFun (ASic: Pointer; AFuname, AFunami: PAnsiChar): Integer;
begin
  Result := sic_exfun (ASic, AFuname, AFunami);
end;

function T_SICs64.AddConF (ASic: Pointer; AConame: PAnsiChar;
  AValue: Double): Integer;
begin
  Result := sic_aconf (ASic, AConame, AValue);
end;

function T_SICs64.AddConI (ASic: Pointer; AConame: PAnsiChar;
  AValue: Integer): Integer;
begin
  Result := sic_aconi (ASic, AConame, AValue);
end;

function T_SICs64.AddConS (ASic: Pointer; AConame,
  AValue: PAnsiChar): Integer;
begin
  Result := sic_acons (ASic, AConame, AValue);
end;

function T_SICs64.AddConO (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_acono (ASic, AConame, AValue);
end;

function T_SICs64.AddConP (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconp (ASic, AConame, AValue);
end;

function T_SICs64.AddConPF (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconpf (ASic, AConame, AValue);
end;

function T_SICs64.AddConPI (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconpi (ASic, AConame, AValue);
end;

function T_SICs64.AddConPS (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconps (ASic, AConame, AValue);
end;

function T_SICs64.RenameCon (ASic: Pointer; AConame, AOrgname: PAnsiChar;
  AInvalidate: WordBool): Integer;
begin
  Result := sic_recon (ASic, AConame, AOrgname, AInvalidate);
end;

function T_SICs64.DuplicateCon (ASic: Pointer; AConame, AOrgname: PAnsiChar): Integer;
begin
  Result := sic_ducon (ASic, AConame, AOrgname);
end;

function T_SICs64.ExchangeCon (ASic: Pointer; AConame, AConami: PAnsiChar): Integer;
begin
  Result := sic_excon (ASic, AConame, AConami);
end;

function T_SICs64.AddVarF (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarf (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarI (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avari (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarS (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avars (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarO (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avaro (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarP (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarp (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarPF (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarpf (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarPI(ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarpi (ASic, AVaname, AOffset);
end;

function T_SICs64.AddVarPS (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarps (ASic, AVaname, AOffset);
end;

function T_SICs64.RenameVar (ASic: Pointer; AVaname, AOrgname: PAnsiChar;
  AInvalidate: WordBool): Integer;
begin
  Result := sic_revar (ASic, AVaname, AOrgname, AInvalidate);
end;

function T_SICs64.DuplicateVar (ASic: Pointer; AVaname, AOrgname: PAnsiChar): Integer;
begin
  Result := sic_duvar (ASic, AVaname, AOrgname);
end;

function T_SICs64.ExchangeVar (ASic: Pointer; AVaname, AVanami: PAnsiChar): Integer;
begin
  Result := sic_exvar (ASic, AVaname, AVanami);
end;

function T_SICs64.InvalidateFun (ASic: Pointer; AFuname: PAnsiChar): Integer;
begin
  Result := sic_invaf (ASic, AFuname);
end;

function T_SICs64.InvalidateCon (ASic: Pointer; AConame: PAnsiChar): Integer;
begin
  Result := sic_invac (ASic, AConame);
end;

function T_SICs64.InvalidateVar (ASic: Pointer; AVaname: PAnsiChar): Integer;
begin
  Result := sic_invav (ASic, AVaname);
end;

procedure T_SICs64.PackTables (ASic: Pointer);
begin
  sic_patab (ASic);
end;

procedure T_SICs64.PackFunTable (ASic: Pointer);
begin
  sic_pafut (ASic);
end;

procedure T_SICs64.PackConTable (ASic: Pointer);
begin
  sic_pacot (ASic);
end;

procedure T_SICs64.PackVarTable (ASic: Pointer);
begin
  sic_pavat (ASic);
end;

function T_SICs64.GetFunTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gefut (ASic);
end;

function T_SICs64.GetFunCount (ASic: Pointer): LongWord;
begin
  Result := sic_gefuc (ASic);
end;

function T_SICs64.GetFunItem (ASic: Pointer; AIndex: Integer;
...
function T_SICs64.GetFunIndex (ASic: Pointer; AFuname: PAnsiChar): Integer;
begin
  Result := sic_gefun (ASic, AFuname);
end;

function T_SICs64.GetConTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gecot (ASic);
end;

function T_SICs64.GetConCount (ASic: Pointer): LongWord;
begin
  Result := sic_gecoc (ASic);
end;

function T_SICs64.GetConItem (ASic: Pointer; AIndex: Integer;
...
function T_SICs64.GetConIndex (ASic: Pointer; AConame: PAnsiChar): Integer;
begin
  Result := sic_gecon (ASic, AConame);
end;

function T_SICs64.GetVarTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gevat (ASic);
end;

function T_SICs64.GetVarCount (ASic: Pointer): LongWord;
begin
  Result := sic_gevac (ASic);
end;

function T_SICs64.GetVarItem (ASic: Pointer; AIndex: Integer;
...
function T_SICs64.GetVarIndex (ASic: Pointer; AVaname: PAnsiChar): Integer;
begin
  Result := sic_gevar (ASic, AVaname);
end;

function T_SICs64.GetRunTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gerut (ASic);
end;

function T_SICs64.GetRunCount (ASic: Pointer): LongWord;
begin
  Result := sic_geruc (ASic);
end;

function T_SICs64.GetRunItem (ASic: Pointer; AIndex: Integer;
  var AItem: TSIC_ConItem): Integer;
var
  I : TSIC__ConItem;
begin
...
function T_SICs64.GetRunIndex (ASic: Pointer; ARuname: PAnsiChar): Integer;
begin
  Result := sic_gerun (ASic, ARuname);
end;

function T_SICs64.Compile (ASic: Pointer; S: PAnsiChar;
  ASop: LongWord): LongWord;
begin
  Result := sic_compile (ASic, S, ASop);
end;

function T_SICs64.Build (ASic: Pointer; S: PAnsiChar;
  ASop: LongWord): LongWord;
begin
  Result := sic_build (ASic, S, ASop);
end;

function T_SICs64.Exec (ASic: Pointer; var AError: LongWord): Double;
begin
  Result := sic_exec (ASic, AError);
end;

procedure T_SICs64.Call (ASic: Pointer);
begin
  sic_call (ASic);
end;

function T_SICs64.CoExec (ASic: Pointer; S: PAnsiChar; var ASop,
  AError: LongWord): Double;
begin
  Result := sic_cexec (ASic, S, ASop, AError);
end;

function T_SICs64.BuExec (ASic: Pointer; S: PAnsiChar; var ASop,
  AError: LongWord): Double;
begin
  Result := sic_bexec (ASic, S, ASop, AError);
end;

function T_SICs64.SCoExec (S: PAnsiChar; var ASop, AError: LongWord): Double;
begin
  Result := sic_scexec (S, ASop, AError);
end;

function T_SICs64.SBuExec (S: PAnsiChar; var ASop, AError: LongWord): Double;
begin
  Result := sic_sbexec (S, ASop, AError);
end;

function T_SICs64.va_count: Integer;
begin
  Result := sic_va_count;
end;

function T_SICs64.inda (ACode: Pointer; AData: Pointer; Ax64: Byte): Integer;
begin
  Result := sic_inda (ACode, AData, Ax64);
end;

function T_SICs64.cpuseed: Largeuint;
begin
  Result := SICxProcs.cpuseed;
end;

function T_SICs64.cpuseed64: Largeuint;
begin
  Result := SICxProcs.cpuseed64;
end;

function T_SICs64.cpuseed32: LongWord;
begin
  Result := SICxProcs.cpuseed32;
end;

function T_SICs64.cpuseed16: Word;
begin
  Result := SICxProcs.cpuseed16;
end;

function T_SICs64.cpurand: Largeuint;
begin
  Result := SICxProcs.cpurand;
end;

function T_SICs64.cpurand64: Largeuint;
begin
  Result := SICxProcs.cpurand64;
end;

function T_SICs64.cpurand32: LongWord;
begin
  Result := SICxProcs.cpurand32;
end;

function T_SICs64.cpurand16: Word;
begin
  Result := SICxProcs.cpurand16;
end;

function T_SICs64.cpurandf: Double;
begin
  Result := SICxProcs.cpurandf;
end;

function T_SICs64.cpurandf2pi: Double;
begin
  Result := SICxProcs.cpurandf2pi;
end;

function T_SICs64.mt19937_igen: Largeuint;
begin
  Result := SICxProcs.mt19937_igen;
end;

function T_SICs64.mt19937_fgen: Double;
begin
  Result := SICxProcs.mt19937_fgen;
end;

function T_SICs64.mt19937_fgen2pi: Double;
begin
  Result := SICxProcs.mt19937_fgen2pi;
end;

procedure T_SICs64.mt19937_seed (ASeed: Largeuint);
begin
  SICxProcs.mt19937_seed (ASeed);
end;

procedure T_SICs64.mt19937_seeds (ASeeds: Pointer; ACount: Largeuint);
begin
  SICxProcs.mt19937_seeds (ASeeds, ACount);
end;

function T_SICs64.sic_erf (A: Double): Double;
begin
  Result := SICxProcs.sic_erf (A);
end;

function T_SICs64.sic_erfc (A: Double): Double;
begin
  Result := SICxProcs.sic_erfc (A);
end;

function T_SICs64.sic_cdfnorm (A: Double): Double;
begin
  Result := SICxProcs.sic_cdfnorm (A);
end;

function T_SICs64.sic_erfinv (A: Double): Double;
begin
  Result := SICxProcs.sic_erfinv (A);
end;

function T_SICs64.sic_erfcinv (A: Double): Double;
begin
  Result := SICxProcs.sic_erfcinv (A);
end;

function T_SICs64.sic_cdfnorminv (A: Double): Double;
begin
  Result := SICxProcs.sic_cdfnorminv (A);
end;

function T_SICs64.sic_lgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_lgamma (A);
end;

function T_SICs64.sic_lgammas (A: Double; var S: LongWord): Double;
begin
  Result := SICxProcs.sic_lgammas (A, S);
end;

function T_SICs64.sic_tgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_tgamma (A);
end;

function T_SICs64.sic_rgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_rgamma (A);
end;

function T_SICs64.sic_rtgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_rtgamma (A);
end;

function T_SICs64.sic_beta (A, B: Double): Double;
begin
...
initialization
  {$IFDEF SIC_OCX}
  TTypedComObjectFactory.Create (ComServer, T_SICs64, CLASS_SICos64,
