...
uses
  Winapi.Windows, Winapi.ActiveX, System.Classes, System.Win.ComObj, SICx32_TLB;
...
type
  T_SICx32 = class (TTypedComObject, ISICx32)
  protected
...
function T_SICx32.Version: LongWord;
begin
  Result := sic_version;
end;

function T_SICx32.CPUSupport: WordBool;
begin
  Result := sic_cpu_support;
end;

procedure T_SICx32.Setup (AConfig: Pointer);
begin
  sic_setup (AConfig);
end;

procedure T_SICx32.CreateTables;
begin
  sic_cretab;
end;

procedure T_SICx32.FreeTables;
begin
  sic_fretab;
end;

function T_SICx32.FunTableCreate: LongWord;
begin
  Result := sic_funtac;
end;

procedure T_SICx32.FunTableFree;
begin
  sic_funtaf;
end;

function T_SICx32.FunLoad: LongWord;
begin
  Result := sic_funloa;
end;

procedure T_SICx32.FunUnload;
begin
  sic_funulo;
end;

function T_SICx32.ConTableCreate: LongWord;
begin
  Result := sic_contac;
end;

procedure T_SICx32.ConTableFree;
begin
  sic_contaf;
end;

function T_SICx32.ConLoad: LongWord;
begin
  Result := sic_conloa;
end;

procedure T_SICx32.ConUnload;
begin
  sic_conulo;
end;

function T_SICx32.VarTableCreate: LongWord;
begin
  Result := sic_vartac;
end;

procedure T_SICx32.VarTableFree;
begin
  sic_vartaf;
end;

function T_SICx32.VarLoad: LongWord;
begin
  Result := sic_varloa;
end;

procedure T_SICx32.VarUnload;
begin
  sic_varulo;
end;

function T_SICx32.RunTableCreate: LongWord;
begin
  Result := sic_runtac;
end;

procedure T_SICx32.RunTableFree;
begin
  sic_runtaf;
end;

procedure T_SICx32.Init (ASic: Pointer);
begin
  sic_init (ASic);
end;

procedure T_SICx32.Done (ASic: Pointer);
begin
  sic_done (ASic);
end;

function T_SICx32.AddFuns (ASic: Pointer): Integer;
begin
  Result := 0;
  {$I T_SICx.AddFuns.pas}
end;

function T_SICx32.AddFun (ASic: Pointer; AFuname: PAnsiChar; AOffset: Pointer;
  AACount: Smallint; AFlags: Word): Integer;
begin
  Result := sic_afun (ASic, AFuname, AOffset, AACount, AFlags);
end;

function T_SICx32.RenameFun (ASic: Pointer; AFuname, AOrgname: PAnsiChar;
  AInvalidate: WordBool): Integer;
begin
  Result := sic_refun (ASic, AFuname, AOrgname, AInvalidate);
end;

function T_SICx32.DuplicateFun (ASic: Pointer; AFuname, AOrgname: PAnsiChar): Integer;
begin
  Result := sic_dufun (ASic, AFuname, AOrgname);
end;

function T_SICx32.ExchangeFun (ASic: Pointer; AFuname, AFunami: PAnsiChar): Integer;
begin
  Result := sic_exfun (ASic, AFuname, AFunami);
end;

function T_SICx32.AddConF (ASic: Pointer; AConame: PAnsiChar;
  AValue: Double): Integer;
begin
  Result := sic_aconf (ASic, AConame, AValue);
end;

function T_SICx32.AddConI (ASic: Pointer; AConame: PAnsiChar;
  AValue: Integer): Integer;
begin
  Result := sic_aconi (ASic, AConame, AValue);
end;

function T_SICx32.AddConS (ASic: Pointer; AConame,
  AValue: PAnsiChar): Integer;
begin
  Result := sic_acons (ASic, AConame, AValue);
end;

function T_SICx32.AddConO (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_acono (ASic, AConame, AValue);
end;

function T_SICx32.AddConP (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconp (ASic, AConame, AValue);
end;

function T_SICx32.AddConPF (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconpf (ASic, AConame, AValue);
end;

function T_SICx32.AddConPI(ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconpi (ASic, AConame, AValue);
end;

function T_SICx32.AddConPS (ASic: Pointer; AConame: PAnsiChar;
  AValue: Pointer): Integer;
begin
  Result := sic_aconps (ASic, AConame, AValue);
end;

function T_SICx32.RenameCon (ASic: Pointer; AConame, AOrgname: PAnsiChar;
  AInvalidate: WordBool): Integer;
begin
  Result := sic_recon (ASic, AConame, AOrgname, AInvalidate);
end;

function T_SICx32.DuplicateCon (ASic: Pointer; AConame, AOrgname: PAnsiChar): Integer;
begin
  Result := sic_ducon (ASic, AConame, AOrgname);
end;

function T_SICx32.ExchangeCon (ASic: Pointer; AConame, AConami: PAnsiChar): Integer;
begin
  Result := sic_excon (ASic, AConame, AConami);
end;

function T_SICx32.AddVarF (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarf (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarI (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avari (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarS (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avars (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarO (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avaro (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarP (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarp (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarPF (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarpf (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarPI (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarpi (ASic, AVaname, AOffset);
end;

function T_SICx32.AddVarPS (ASic: Pointer; AVaname: PAnsiChar;
  AOffset: Pointer): Integer;
begin
  Result := sic_avarps (ASic, AVaname, AOffset);
end;

function T_SICx32.RenameVar (ASic: Pointer; AVaname, AOrgname: PAnsiChar;
  AInvalidate: WordBool): Integer;
begin
  Result := sic_revar (ASic, AVaname, AOrgname, AInvalidate);
end;

function T_SICx32.DuplicateVar (ASic: Pointer; AVaname, AOrgname: PAnsiChar): Integer;
begin
  Result := sic_duvar (ASic, AVaname, AOrgname);
end;

function T_SICx32.ExchangeVar (ASic: Pointer; AVaname, AVanami: PAnsiChar): Integer;
begin
  Result := sic_exvar (ASic, AVaname, AVanami);
end;

function T_SICx32.InvalidateFun (ASic: Pointer; AFuname: PAnsiChar): Integer;
begin
  Result := sic_invaf (ASic, AFuname);
end;

function T_SICx32.InvalidateCon (ASic: Pointer; AConame: PAnsiChar): Integer;
begin
  Result := sic_invac (ASic, AConame);
end;

function T_SICx32.InvalidateVar (ASic: Pointer; AVaname: PAnsiChar): Integer;
begin
  Result := sic_invav (ASic, AVaname);
end;

procedure T_SICx32.PackTables (ASic: Pointer);
begin
  sic_patab (ASic);
end;

procedure T_SICx32.PackFunTable (ASic: Pointer);
begin
  sic_pafut (ASic);
end;

procedure T_SICx32.PackConTable (ASic: Pointer);
begin
  sic_pacot (ASic);
end;

procedure T_SICx32.PackVarTable (ASic: Pointer);
begin
  sic_pavat (ASic);
end;

function T_SICx32.GetFunTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gefut (ASic);
end;

function T_SICx32.GetFunCount (ASic: Pointer): LongWord;
begin
  Result := sic_gefuc (ASic);
end;

function T_SICx32.GetFunItem (ASic: Pointer; AIndex: Integer;
...
function T_SICx32.GetFunIndex (ASic: Pointer; AFuname: PAnsiChar): Integer;
begin
  Result := sic_gefun (ASic, AFuname);
end;

function T_SICx32.GetConTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gecot (ASic);
end;

function T_SICx32.GetConCount (ASic: Pointer): LongWord;
begin
  Result := sic_gecoc (ASic);
end;

function T_SICx32.GetConItem (ASic: Pointer; AIndex: Integer;
...
function T_SICx32.GetConIndex (ASic: Pointer; AConame: PAnsiChar): Integer;
begin
  Result := sic_gecon (ASic, AConame);
end;

function T_SICx32.GetVarTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gevat (ASic);
end;

function T_SICx32.GetVarCount (ASic: Pointer): LongWord;
begin
  Result := sic_gevac (ASic);
end;

function T_SICx32.GetVarItem (ASic: Pointer; AIndex: Integer;
...
function T_SICx32.GetVarIndex (ASic: Pointer; AVaname: PAnsiChar): Integer;
begin
  Result := sic_gevar (ASic, AVaname);
end;

function T_SICx32.GetRunTable (ASic: Pointer): PAnsiChar;
begin
  Result := sic_gerut (ASic);
end;

function T_SICx32.GetRunCount (ASic: Pointer): LongWord;
begin
  Result := sic_geruc (ASic);
end;

function T_SICx32.GetRunItem (ASic: Pointer; AIndex: Integer;
  var AItem: TSIC_ConItem): Integer;
var
  I : TSIC__ConItem;
begin
...
function T_SICx32.GetRunIndex (ASic: Pointer; ARuname: PAnsiChar): Integer;
begin
  Result := sic_gerun (ASic, ARuname);
end;

function T_SICx32.Compile (ASic: Pointer; S: PAnsiChar;
  ASop: LongWord): LongWord;
begin
  Result := sic_compile (ASic, S, ASop);
end;

function T_SICx32.Build (ASic: Pointer; S: PAnsiChar;
  ASop: LongWord): LongWord;
begin
  Result := sic_build (ASic, S, ASop);
end;

function T_SICx32.Exec (ASic: Pointer; var AError: LongWord): Double;
begin
  Result := sic_exec (ASic, AError);
end;

procedure T_SICx32.Call (ASic: Pointer);
begin
  sic_call (ASic);
end;

function T_SICx32.CoExec (ASic: Pointer; S: PAnsiChar; var ASop,
  AError: LongWord): Double;
begin
  Result := sic_cexec (ASic, S, ASop, AError);
end;

function T_SICx32.BuExec (ASic: Pointer; S: PAnsiChar; var ASop,
  AError: LongWord): Double;
begin
  Result := sic_bexec (ASic, S, ASop, AError);
end;

function T_SICx32.SCoExec (S: PAnsiChar; var ASop, AError: LongWord): Double;
begin
  Result := sic_scexec (S, ASop, AError);
end;

function T_SICx32.SBuExec (S: PAnsiChar; var ASop, AError: LongWord): Double;
begin
  Result := sic_sbexec (S, ASop, AError);
end;

function T_SICx32.va_count: Integer;
begin
  Result := sic_va_count;
end;

function T_SICx32.inda (ACode: Pointer; AData: Pointer; Ax64: Byte): Integer;
begin
  Result := sic_inda (ACode, AData, Ax64);
end;

function T_SICx32.cpuseed: LongWord;
begin
  Result := SICxProcs.cpuseed;
end;

function T_SICx32.cpuseed64: Largeuint;
begin
  Result := SICxProcs.cpuseed64;
end;

function T_SICx32.cpuseed32: LongWord;
begin
  Result := SICxProcs.cpuseed32;
end;

function T_SICx32.cpuseed16: Word;
begin
  Result := SICxProcs.cpuseed16;
end;

function T_SICx32.cpurand: LongWord;
begin
  Result := SICxProcs.cpurand;
end;

function T_SICx32.cpurand64: Largeuint;
begin
  Result := SICxProcs.cpurand64;
end;

function T_SICx32.cpurand32: LongWord;
begin
  Result := SICxProcs.cpurand32;
end;

function T_SICx32.cpurand16: Word;
begin
  Result := SICxProcs.cpurand16;
end;

function T_SICx32.cpurandf: Double;
begin
  Result := SICxProcs.cpurandf;
end;

function T_SICx32.cpurandf2pi: Double;
begin
  Result := SICxProcs.cpurandf2pi;
end;

function T_SICx32.mt19937_igen: LongWord;
begin
  Result := SICxProcs.mt19937_igen;
end;

function T_SICx32.mt19937_fgen: Double;
begin
  Result := SICxProcs.mt19937_fgen;
end;

function T_SICx32.mt19937_fgen2pi: Double;
begin
  Result := SICxProcs.mt19937_fgen2pi;
end;

procedure T_SICx32.mt19937_seed (ASeed: LongWord);
begin
  SICxProcs.mt19937_seed (ASeed);
end;

procedure T_SICx32.mt19937_seeds (ASeeds: Pointer; ACount: LongWord);
begin
  SICxProcs.mt19937_seeds (ASeeds, ACount);
end;

function T_SICx32.sic_erf (A: Double): Double;
begin
  Result := SICxProcs.sic_erf (A);
end;

function T_SICx32.sic_erfc (A: Double): Double;
begin
  Result := SICxProcs.sic_erfc (A);
end;

function T_SICx32.sic_cdfnorm (A: Double): Double;
begin
  Result := SICxProcs.sic_cdfnorm (A);
end;

function T_SICx32.sic_erfinv (A: Double): Double;
begin
  Result := SICxProcs.sic_erfinv (A);
end;

function T_SICx32.sic_erfcinv (A: Double): Double;
begin
  Result := SICxProcs.sic_erfcinv (A);
end;

function T_SICx32.sic_cdfnorminv (A: Double): Double;
begin
  Result := SICxProcs.sic_cdfnorminv (A);
end;

function T_SICx32.sic_lgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_lgamma (A);
end;

function T_SICx32.sic_lgammas (A: Double; var S: LongWord): Double;
begin
  Result := SICxProcs.sic_lgammas (A, S);
end;

function T_SICx32.sic_tgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_tgamma (A);
end;

function T_SICx32.sic_rgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_rgamma (A);
end;

function T_SICx32.sic_rtgamma (A: Double): Double;
begin
  Result := SICxProcs.sic_rtgamma (A);
end;

function T_SICx32.sic_beta (A, B: Double): Double;
begin
...
initialization
  {$IFDEF SIC_OCX}
  TTypedComObjectFactory.Create (ComServer, T_SICx32, CLASS_SICox32,
